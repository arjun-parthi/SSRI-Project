...
file1 = 'data_ml/STRIDE_PATIENT.xlsx'
...
stride_patient_req = stride_patient.drop(['DEATH_DATE', 'RELIGION', 'LANGUAGE', 'PATIENT_TYPE', 'RECENT_HT_IN_CMS', 'RECENT_WT_IN_KGS', 'COUNTY', 'LOAD_DATE' ], axis=1)
...
print(pat_surgery.dtypes)
writer = pd.ExcelWriter('data_ml/PATIENT_FINAL.xlsx')
